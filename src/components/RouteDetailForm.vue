...
<template>
  <div style="display: flex;flex-direction: column">
    ...
    <div>
      <el-button @click="add = true" style="margin-bottom: 3%; float:right;" icon="Plus">
        添加站点
      </el-button>
    </div>
            ...
            <div style="display: flex; flex-direction: row; justify-items: center; align-items: center;">
              <el-space>
                <el-button class="change"
                  @click="toEditIndex = route.station_ids.indexOf(station); toEditId = station; edit = true" icon="Edit">
                  编辑
                </el-button>
                <div>
